...
public class EditPlants extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDateFormat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        EditPlants.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,onDateSetListener, year, month, day);
        ...
        PlantName.setText(plants_Name);
        mDateFormat.setText(plants_AdoptionDate);
        PlantLocation.setText(plants_Location);
        PlantDiscription.setText(plants_Discription);

        waterTimes.setText(plants_WaterTimes);
        adapterItems = new ArrayAdapter<String>(this,R.layout.drop_waterlist,wateritemstimes);
        waterTimes.setAdapter(adapterItems);

        fertilizerTimes.setText(plants_FertilizerTimes);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(plants_Name.equals("")){
                    ...
                    Toast.makeText(EditPlants.this, "please fill adaption date", Toast.LENGTH_SHORT).show();
                }else if(plants_WaterRepeat.equals("") || plants_WaterTimes.equals("") || plants_FertilizerRepeat.equals("") || plants_FertilizerTimes.equals("")){
                    Toast.makeText(EditPlants.this, "please insert repeat and times", Toast.LENGTH_SHORT).show();
                }else{
                    Boolean result = plantsDB.updatePlants(String.valueOf(plants_no), plants_Name, plants_Date, plants_WaterRepeat, plants_WaterTimes, plants_FertilizerRepeat, plants_FertilizerTimes, plants_Location, plants_Discription, ImageToByte(InPhoto));
                    if(result == true){
                        Toast.makeText(EditPlants.this, plants_Name + " edited successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(EditPlants.this, MainPlants.class);
                        startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(EditPlants.this).toBundle());
                    }else {
                        Toast.makeText(EditPlants.this, "No plant changes", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
